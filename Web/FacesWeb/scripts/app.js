    ...
    app.config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
          .state('home', {
              ...
              views: {
                  'main-view': {
                      templateUrl: "components/MainView.html",
          ...
          .state('home.manualcontrol', {
              ...
              views: {
                  'schedulers': {
                      templateUrl: "components/BoilerControl.html",
          ...
          .state('home.dayscheduler', {
              ...
              views: {
                  'schedulers': {
                      templateUrl: "components/DayScheduler.html",
          ...
          .state('home.weekscheduler', {
              ...
              views: {
                  'schedulers': {
                      templateUrl: 'components/WeekScheduler.html',
          ...
          .state('home.monthscheduler', {
              ...
              views: {
                  'schedulers': {
                      templateUrl: 'components/MonthScheduler.html',
